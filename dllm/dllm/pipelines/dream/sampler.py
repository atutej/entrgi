...
def sample_tokens(
    ...
    if temperature > 0:
        try:
            # Use logits (already temperature-scaled) directly — more numerically stable
            # than Categorical(probs=softmax(logits/T)), which overflows at low T.
        ...
        **kwargs,
        ...
        for i in range(effective_steps):
            ...
            full_confidence = torch.full_like(
                x, -torch.inf, device=self.model.device, dtype=torch.float32
            )
